...
export async function formDuo(playerId, partnerId) { return (await backend()).formDuo(playerId, partnerId); }
export async function disbandDuo(duoId) { return (await backend()).disbandDuo(duoId); }
